class RanksController < ApplicationController
  ...
  def destroy
    @rank.destroy
    respond_to do |format|
      format.html { redirect_to ranks_url, notice: 'Rank destruction: ' + @rank.errors[:deletion_status].join(' ') }
  ...
  private
    ...
    def rank_params
      params.require(:rank).permit(:id, :style_id, :name, :translation, :order, :active, :class_delta, :next_rank_test_id, :belt_color_id, :stripe_color_id, :stripe_count)
    end
end
